...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/apis.md
...
- name: Microsoft Graph List Available Drives
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/drives-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/drives-get-openapi.md
- name: Microsoft Graph List Available Drives
  x-api-slug: microsoft-graph
  description: List available drives Retrieve the list of Drive resources available
    for a target User or Group. Your app can also request the set of document libraries
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/medrives-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/medrives-get-openapi.md
- name: Microsoft Graph List Available Drives
  x-api-slug: microsoft-graph
  description: List available drives Retrieve the list of Drive resources available
    for a target User or Group. Your app can also request the set of document libraries
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/groupsiddrives-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/groupsiddrives-get-openapi.md
- name: Microsoft Graph
  x-api-slug: microsoft-graph
  description: 'Microsoft Graph exposes multiple APIs from Office 365 and other Microsoft
    cloud services through a single endpoint: https://graph.microsoft.com. Microsoft
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/drives/master/_listings/microsoft-graph/openapi.md
x-common:
- type: x-change-loge
